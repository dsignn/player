const PlaylistEntity = (async () => {      
     ...
     */
    class PlaylistEntity extends EntityIdentifier {
    ...
    return {PlaylistEntity: PlaylistEntity};
})();

export default PlaylistEntity;
export const then = PlaylistEntity.then.bind(PlaylistEntity);