const MonitorMosaic = (async () => {     

    const { MonitorEntity } = await import(`${container.get('Application').getBasePath()}module/monitor/src/entity/MonitorEntity.js`);
    ...
    return {MonitorMosaic: MonitorMosaic};
})();

export default MonitorMosaic;
export const then = MonitorMosaic.then.bind(MonitorMosaic);