(async () => {
    ...
    await import('./../soccer-add-score/soccer-add-score.js');
    /**
     * @customElement
     * @polymer
     */
    class SoccerScoreboard extends LocalizeMixin(ServiceInjectorMixin(PolymerElement)) {
    ...
    window.customElements.define('soccer-scoreboard', SoccerScoreboard);
})()