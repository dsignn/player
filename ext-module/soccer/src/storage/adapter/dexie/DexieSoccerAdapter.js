const DexieSoccerAdapter = (async () => {   
     ...
     */
    class DexieSoccerAdapter extends DexieAdapter {
    ...
    return {DexieSoccerAdapter: DexieSoccerAdapter};
})();

export default DexieSoccerAdapter;
export const then = DexieSoccerAdapter.then.bind(DexieSoccerAdapter);