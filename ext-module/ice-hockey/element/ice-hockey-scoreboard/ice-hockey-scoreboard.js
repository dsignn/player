(async () => {
    ...
    await import('./../paper-ice-hockey-player/paper-ice-hockey-player.js');
    await import('./../ice-hockey-add-player/ice-hockey-add-player.js');
    await import('./../ice-hockey-add-score/ice-hockey-add-score.js');
    /**
     * @customElement
     * @polymer
     */
